...
class TileTest < ActiveSupport::TestCase
  ...
  test "don't allow non-starter tile placed surrounded by no other tile" do
    tile = Tile.new(x: 500, y:500, start: false, **four_sided_road_tile, game: game)
    tile.valid?
  ...
  test "allow starter tile placed surrounded by no other tile" do
    tile = Tile.new(x: 500, y:500, start: true, **four_sided_road_tile, game: game)
    tile.valid?
    assert tile.errors.empty?
  end

  test "allow road attach from east to west" do
    tile = Tile.new(x: -1, y: 0, **four_sided_road_tile, game: game)
    tile.valid?
    assert tile.errors.empty?
  end

  test "don't allow road attach to non-road from east to west" do
    tile = Tile.new(x: 1, y: 2, **four_sided_road_tile, game: game)
    tile.valid?
    assert_equal tile.errors.full_messages.first, 
  ...
  test "don't allow road attach to non-road from west to east" do
    tile = Tile.new(x: 3, y: 2, **four_sided_road_tile, game: game)
    tile.valid?
    assert_equal tile.errors.full_messages.first, 
  ...
  test "allow road attach from north to south" do
    tile = Tile.new(x: 0, y: -1, **four_sided_road_tile, game: game)
    tile.valid?
    assert tile.errors.empty?
  end

  test "don't allow road attach to non-road from north to south" do
    tile = Tile.new(x: 2, y: 1, **four_sided_road_tile, game: game)
    tile.valid?
    assert_equal tile.errors.full_messages.first, 
  ...
  test "don't allow road attach to non-road from south to north" do
    tile = Tile.new(x: 2, y: 3, **four_sided_road_tile, game: game)
    tile.valid?
    assert_equal tile.errors.full_messages.first, 
  ...
  test "allow castle attach from east to west" do
    tile = Tile.new(x: 1, y: 2, **four_sided_castle_tile, game: game)
    tile.valid?
    assert tile.errors.empty?
  end

  test "don't allow castle attach to non-castle from east to west" do
    tile = Tile.new(x: -1, y: 0, **four_sided_castle_tile, game: game)
    tile.valid?
    assert_equal tile.errors.full_messages.first, 
  ...
  test "allow castle attach from west to east" do
    tile = Tile.new(x: 3, y: 2, **four_sided_castle_tile, game: game)
    tile.valid?
    assert tile.errors.empty?
  end

  test "don't allow castle attach to non-castle from west to east" do
    tile = Tile.new(x: 5, y: 4, **four_sided_castle_tile, game: game)
    tile.valid?
    assert_equal tile.errors.full_messages.first, 
  ...
  test "allow castle attach from north to south" do
    tile = Tile.new(x: 2, y: 1, **four_sided_castle_tile, game: game)
    tile.valid?
    assert tile.errors.empty?
  end

  test "don't allow castle attach to non-castle from north to south" do
    tile = Tile.new(x: 0, y: -1, **four_sided_castle_tile, game: game)
    tile.valid?
    assert_equal tile.errors.full_messages.first, 
  ...
  test "allow castle attach from south to north" do
    tile = Tile.new(x: 2, y: 3, **four_sided_castle_tile, game: game)
    tile.valid?
    assert tile.errors.empty?
  end
  ...
  test "allow field attach from east to west" do
    tile = Tile.new(x: 3, y: 4, **four_sided_field_tile, game: game)
    tile.valid?
    assert tile.errors.empty?
  end

  test "don't allow field attach to non-field from east to west" do
    tile = Tile.new(x: 1, y: 2, **four_sided_field_tile, game: game)
    tile.valid?
    assert_equal tile.errors.full_messages.first, 
  ...
  test "allow field attach from west to east" do
    tile = Tile.new(x: 5, y: 4, **four_sided_field_tile, game: game)
    tile.valid?
    assert tile.errors.empty?
  end

  test "don't allow field attach to non-field from west to east" do
    tile = Tile.new(x: 1, y: 0, **four_sided_field_tile, game: game)
    tile.valid?
    assert_equal tile.errors.full_messages.first, 
  ...
  test "allow field attach from north to south" do
    tile = Tile.new(x: 4, y: 3, **four_sided_field_tile, game: game)
    tile.valid?
    assert tile.errors.empty?
  end

  test "don't allow field attach to non-field from north to south" do
    tile = Tile.new(x: 0, y: -1, **four_sided_field_tile, game: game)
    tile.valid?
    assert_equal tile.errors.full_messages.first, 
  ...
  test "allow field attach from south to north" do
    tile = Tile.new(x: 4, y: 5, **four_sided_field_tile, game: game)
    tile.valid?
    assert tile.errors.empty?
  end
  ...
  test "don't create a tile without a game" do
